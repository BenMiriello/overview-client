...
const DETAIL_PRESETS: Record<DetailLevel, Omit<SimulationConfig, 'fieldConfig'>> = {
  [DetailLevel.GLOBE]: {
    ...
    maxBranchDepth: 4,
    baseBranchProb: 0.35,
    branchSurvivalDecay: 0.95,
    branchProgressDecay: 0.10,
    maxBranchesPerStep: 4,
    connectionThreshold: 0.02,
    maxSegments: 150,
    postBranchProb: 0.20,
    postBranchMinLength: 8,
    postBranchMaxLength: 15,
    postBranchAngleMin: 12,
    postBranchAngleMax: 28,
    mainChannelJitter: 1.5,
    jitterDecayRate: 0.97,
    branchDownwardBias: 0.3,
    maxPostBranchDepth: 2,
    subBranchProbDecay: 0.6,
    subBranchLengthDecay: 0.5,
    branchIntensityDecay: 0.7,
  },
  [DetailLevel.SHOWCASE]: {
    ...
    maxBranchDepth: 4,
    baseBranchProb: 0.30,
    branchSurvivalDecay: 0.96,
    branchProgressDecay: 0.08,
    maxBranchesPerStep: 4,
    connectionThreshold: 0.02,
    maxSegments: 1200,
    postBranchProb: 0.25,
    postBranchMinLength: 8,
    postBranchMaxLength: 20,
    postBranchAngleMin: 12,
    postBranchAngleMax: 28,
    mainChannelJitter: 1.5,
    jitterDecayRate: 0.97,
